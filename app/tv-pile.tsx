...
const TVS: TvDef[] = [
  ...
  { id: "c", x: 211, y: 311, w: 164, h: 118, body: "#8f5df0", panel: "#7b4ede", bezel: "#1c1230", acc1: "#ef99c2", acc2: "#f0e6ff", type: "plain", controls: "sliders", screen: "rect" },
  { id: "e", x: 226, y: 208, w: 140, h: 106, body: "#5c5480", panel: "#76573b", bezel: "#191426", acc1: "#b9a5f7", acc2: "#ef99c2", type: "antenna", controls: "dials", screen: "rect", shape: "arch", panelWood: true },
