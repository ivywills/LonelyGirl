 ...
 * The page loads .webp (scripts/make-webp.mjs, ~25x smaller than the PNG
 * sources); the alpha masks stay PNG because their channels are packed data.
 */
export const ART = {
  color: "/final_tv_color.webp",
  /** Wall + floor with the TVs inpainted away — what a shifted TV reveals. */
  plate: "/final_tv_plate.webp",
  /** Per-TV coverage masks: RGBA channels carry TVs 0-3 and 4-7. */
  alphaA: "/final_tv_alpha_a.png",
  alphaB: "/final_tv_alpha_b.png",
  glint: "/final_tv_glint.webp",
  width: 2016,
  height: 1134,
};
 ...
 *     fit      "cover" crops a video to fill the glass; default fits the
 *              whole frame and letterboxes the remainder on white.
 */
/*
...
export const TVS = [
  {
    ...
    screen: {
      ...
      radius: 0.24,
      bulge: 0.1,
      fit: "cover", // square clip on a non-square screen — crop, don't letterbox
      source: { type: "video", src: "/clips/events.mp4" },
    },
  },
  {
    ...
    screen: {
      ...
      bulge: 0.07,
      fit: "cover", // square clip on a non-square screen — crop, don't letterbox
      zoom: 1.25, // the bubbles sit inside wide painted margins — trim ~10%/side
      source: { type: "video", src: "/clips/chat.mp4" },
    },
  },
  {
  ...
  },
  {
    ...
    screen: {
      ...
      bulge: 0.08,
      fit: "cover", // square clip on a non-square screen — crop, don't letterbox
      source: { type: "video", src: "/clips/scrapbook.mp4" },
    },
  },
];
...
export const MOBILE_ART = {
  color: "/final_tv_mobile_color.webp",
  glint: "/final_tv_mobile_glint.webp",
  width: 1200,
  height: 1600,
};
...
export const MOBILE_TVS = [
  ...
  {
    // Column order is destination order, not artwork order: the painted sets
    // stay put; only what each one shows and links to changes.
    name: "Store",
    href: "/shop",
